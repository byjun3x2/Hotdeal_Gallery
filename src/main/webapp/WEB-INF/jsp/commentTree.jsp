    ...
    <c:if test="${comment.commentId == param.commentId}">
        ...
        <div class="comment-item" style="margin-left: ${currentDepth * 40}px;">
            <div class="comment-main">
                ...
                <span style="color:#aaa;">${comment.regDate}</span><br>
        ...
        <c:if test="${not empty sessionScope.loginUser}">
            <form class="replyForm" id="replyForm-${comment.commentId}" method="post" action="addComment" style="margin-left: ${(currentDepth + 1) * 40}px;">
